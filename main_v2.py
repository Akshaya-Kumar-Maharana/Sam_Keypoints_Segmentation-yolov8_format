...
def on_key_press(event):
    ...
    if user_input != 'None':
        ...
        while count_countour < len(contour):
            ...
            count_countour += 1
        print("#####################################################################################")
        print("Area of contour:", area_list)
        area_index = area_list.index(max(area_list))
        normalized_points = normalize_points(contour[area_index], original_img_width, original_img_height)
    ...
    while count < len(img_list):
        ...
        while True:
            ...
            if chr(key) == 'a':
                ...
                print(masks)
                print('length_of_mask:', len(masks[0]))
